...
The knowledge need for setting up and maintain his own GeoLog is a background in software C, C++ and knowledge in electric circuits. % %For further development one would...
...
Before the system is set up the aria chosen needs to be checked for GSM signal.\textbf{Warning: There has to be GPRS coverages for the GeoLog to send data to the HTTP server.}
...
\\
\\
If any further errors or malfunctions occur please contact our development team through our github accounted \url{https://github.com/GeoLogTeam/geolog}.  
