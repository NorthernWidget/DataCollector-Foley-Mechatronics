...
\begin{table}[H]
	...
	\begin{tabular}
		...
		\hline
		\textbf{Transmit time} & \textbf{Timestamp [sec]} & \textbf{Sensor ID} & \textbf{Temperature $\degree$C}  \\ \hline
...
The likely reason why the system stopped sending data is the mother hub did not receive data from one or more of the wireless sensor modules. More research has to be done to confirm this.
	\begin{table}[H]
		...
		\begin{tabular}
			{| p{6cm} |  p{4cm} | p{2cm} | p{3cm}  |}
			\hline
			\textbf{Transmit time} & \textbf{Timestamp [sec]} & \textbf{Tensor ID} & \textbf{Temperature $\degree$C}  \\ \hline
